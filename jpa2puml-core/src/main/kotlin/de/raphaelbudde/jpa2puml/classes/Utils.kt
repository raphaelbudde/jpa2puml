...
/**
 * Signature might be "Ljava/util/List<+Lde/raphaelbudde/jpa2puml/example/domain1/LineElement;>;"
 * return will be listOf("de.raphaelbudde.jpa2puml.example.domain1.LineElement")
 */
...
/**
 * +Lde/raphaelbudde/jpa2puml/example/domain1/LineElement -> de.raphaelbudde.jpa2puml.example.domain1.LineElement
 */
