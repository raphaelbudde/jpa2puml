...
class Jpa2PumlTest {
    ...
    fun init() {
        classes =
            JavaClassFinder().findClassFiles(
                listOf(File("../examples/example-domain/target/classes/de/raphaelbudde/jpa2puml/example/domain1")),
            )
...
""",
        ...
        assertThat(lineElementFull.renderRelationsAndNotes()).isEqualTo(
            """de.raphaelbudde.jpa2puml.example.domain1.LineElement "0..*" --> "0..1" de.raphaelbudde.jpa2puml.example.domain1.LineElement : relatedLineElement
de.raphaelbudde.jpa2puml.example.domain1.LineElement -up-|> de.raphaelbudde.jpa2puml.example.domain1.AbstractEntity
de.raphaelbudde.jpa2puml.example.domain1.LineElement .. de.raphaelbudde.jpa2puml.example.domain1.LineElementType
""",
        )
    }
